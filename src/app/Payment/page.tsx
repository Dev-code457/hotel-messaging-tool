...
export default function Payment() {
  ...
  const handlePayment = async (planAmount: number, userId: string, planType: string) => {
    ...
    try {
      const { data } = await axiosPost<CreateOrderResponse, any>("http://http://goodpeggtouch-loadbalanacer-1737380281.ap-south-1.elb.amazonaws.com/api/payment/create-order", {
        amount: planAmount,
        currency: "INR",
      });
      ...
      const razorpayOptions = {
        ...
        handler: async (response: RazorpayResponse) => {
          try {
            // Verify payment
            await axiosPost("http://http://goodpeggtouch-loadbalanacer-1737380281.ap-south-1.elb.amazonaws.com/api/payment/verify-payment", {
            ...
            // Save transaction
            await axiosPost("http://http://goodpeggtouch-loadbalanacer-1737380281.ap-south-1.elb.amazonaws.com/api/payment/save-transaction", {
              paymentData: {
                orderId: response.razorpay_order_id,
                paymentId: response.razorpay_payment_id,
                amount: planAmount,
            ...
            // Activate plan
            await axiosPost("http://http://goodpeggtouch-loadbalanacer-1737380281.ap-south-1.elb.amazonaws.com/api/user/activate-plan", {
              userId,
