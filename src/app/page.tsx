            ...
            <Section heading="Login" classnames="flex-col  h-[50vh] w-[85%]  space-x-4">
              ...
              <form onSubmit={handleSubmit} className="w-[60%] -mb-6 ">
                ...
                <Input
                  ...
                  value={password}
                  required
                  type="password"  // Ensures that the password visibility toggle logic is triggered
              ...
              /> */}
                <div className="flex justify-start -mb-5 py-3">
                  <Button
                    text={loading ? <div className={"flex gap-2 font-bold justify-center items-center"}><Spinner /> Please Wait...</div> : "Sign In"}
